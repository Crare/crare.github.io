...
<a href="https://github.com/liballeg/allegro5/wiki/Allegro-Vivace" target="_blank">You can find Allegro Vivace tutorials here</a>.
...
So anyway this was a good tutorial to the Allegro library. I found the library as I researched how <a href="https://www.factorio.com/" target="_blank">Factorio</a> was made. As it is very powerful game with many sprites and mechanics working simultaneously, I figured out learning what they used to make it would be interesting at the least. It was originally made using <a href="https://liballeg.org/" target="_blank">Allegro</a>, but they later changed to use <a href="https://libsdl.org/" target="_blank">SDL2</a>, because of the <a href="https://www.factorio.com/blog/post/fff-230" target="_blank">technical issues and driver problems</a> and to work further down the line.
