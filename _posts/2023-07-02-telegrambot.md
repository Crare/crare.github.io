...
It uses many Open API's such as <a href="https://www.digitraffic.fi/en/railway-traffic/">Digitraffic's Train traffic data</a>, weather forecasts from <a href="https://openweathermap.org/api">openweathermap.org</a> and even <a href="https://yle.fi/uutiset/rss">YLE news</a>. You could see upcoming movies from TV with Leffatykki's API(seems to be not available anymore) and <a href="https://ruuvi.com/">Ruuvitags</a> were also implemented to it.
...
Project <a href="https://github.com/Crare/telegrambot">source code is available on github</a> if you are interested. It is outdated though and needs a major rework to work properly. Also you need to setups couple of API-keys to make it work. I might resurrect this project at some point.